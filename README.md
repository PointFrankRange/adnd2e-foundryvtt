...
| **7. Player's Option: Combat & Tactics** | 🚧 In progress (Plans 7a-7b/4 done) | Real `CONFIG.statusEffects` wiring (prone/blinded/stunned/held mechanics, the other 11 conditions as flavor markers), a Combat Tracker initiative-modifier UI, critical-hit/fumble severity tables, and armor-vs-weapon-type attack modifiers — weapon mastery and called shots/combat maneuvers still to come (Plans 7c-7d) |
