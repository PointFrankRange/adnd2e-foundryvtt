...
export default tseslint.config(
  ...
  },
  {
    ...
    ignores: ["src/core/**", "tests/core/**", "src/config.ts", "src/conditions.ts", "src/settings/registry.ts", "tests/config/**", "tests/settings/**", "tests/lang/**", "src/data/derive/**", "src/data/item/subtypes.ts", "src/data/item/choices.ts", "src/data/actor/subtypes.ts", "src/data/active-effect/subtypes.ts", "tests/conditions.test.ts", "tests/data/**", "tests/packs/**"],
    languageOptions: {
      globals: {
        game: "readonly",
        Hooks: "readonly",
  ...
  },
  {
    ...
    files: ["src/core/**/*.ts", "tests/core/**/*.ts", "src/config.ts", "src/conditions.ts", "src/settings/registry.ts", "tests/config/**/*.ts", "tests/settings/**/*.ts", "tests/lang/**/*.ts", "src/data/derive/**/*.ts", "src/data/item/subtypes.ts", "src/data/item/choices.ts", "src/data/actor/subtypes.ts", "src/data/active-effect/subtypes.ts", "tests/conditions.test.ts", "tests/data/**/*.ts", "tests/packs/**/*.ts"],
    rules: {
